  ...
  return (
    <div className="min-h-screen grad-mundial flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        {/* Cuadro de ayuda WhatsApp */}
        <div className="mt-4 bg-white/10 backdrop-blur border border-white/20 rounded-2xl px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white/90 text-xs leading-snug">
              ¿Olvidaste tu contraseña? Escríbenos por WhatsApp y te ayudamos.
            </p>
          </div>
          <a
            ...
            className="shrink-0 bg-[#25D366] hover:bg-[#1da851] text-white text-xs font-black px-3 py-1.5 rounded-xl transition-colors whitespace-nowrap"
          >
            Escribir
          </a>
        </div>
